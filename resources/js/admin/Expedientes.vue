      ...
      <div v-for="expediente in paginatedExpedientes" :key="expediente.id" class="col-12 col-md-6 col-lg-4">
        <div class="card h-100 shadow-sm border p-3 position-relative">
          ...
          <div class="card-body d-flex flex-column">
            ...
            <p class="card-text mb-1"><strong>Fecha Creación:</strong> {{ expediente.fecha_creacion }}</p>
            <p class="card-text mb-1"><strong>Nombre:</strong> {{ expediente.nombre }}</p>
          ...
          <div class="modal-body">
            <form @submit.prevent="guardarCambios">
              ...
              <div class="mb-3">
                ...
                <input v-model="expedienteActual.ubicacion_topografica" type="text" class="form-control"
                  placeholder="Ej. Dirección General, Oficina Central, etc." required>
              </div>
    ...
    guardarCambios() {
      axios
        ...
        .then((response) => {
          ...
          this.cargarExpedientes(); // Si tienes un método así
        })
        .catch((error) => {
          console.error(error);
